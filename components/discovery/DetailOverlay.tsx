...
import { Star, Heart, Plus, Check, Trash2, Info } from "lucide-react";
      ...
      {selectedItem && (
        ...
        >
          ...
          >
            ...
            <div
              className={`relative z-10 w-full px-8 pt-10 pb-8 flex-1 overflow-y-auto scrollbar-thin ${
            ...
            >
              {loadingDetails ? (
                ...
                (() => {
                  const isOppenheimer = details.title
                    .toLowerCase()
                    .includes("oppenheimer");
                    ...
                    ? [
                        {
                          ...
                          profileUrl:
                            details.cast.find((c) => c.name.includes("Cillian"))
                              ?.profileUrl || null,
                        },
                        {
                          name: "Robert Downey Jr.",
                          ...
                          profileUrl:
                            details.cast.find((c) => c.name.includes("Downey"))
                              ?.profileUrl || null,
                        },
                        {
                          name: "Emily Blunt",
                          character: "J. Robert Oppenheimer",
                          profileUrl:
                            details.cast.find((c) => c.name.includes("Emily"))
                              ?.profileUrl || null,
                        },
                        {
                          ...
                          character: "Lewis Strauss",
                          profileUrl:
                            details.cast.find((c) => c.name.includes("Alden"))
                              ?.profileUrl || null,
                        },
                      ]
                    : details.cast.slice(0, 4);
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-10 items-start mt-2">
                      ...
                      <div className="lg:col-span-6 space-y-6">
                        <div className="relative mb-14 w-full">
                          {/* Landscape container */}
                          <div
                            className={`overflow-hidden border bg-zinc-900 shadow-2xl aspect-video w-full relative group ${
                              isRetro
                                ? "border-tui-border rounded-none"
                          ...
                          >
                            {playTrailer && details.trailerKey ? (
                              ...
                              <>
                                ...
                                >
                                  <div
                                    className={`w-14 h-14 rounded-full flex items-center justify-center border-2 text-white shadow-2xl scale-100 hover:scale-110 active:scale-95 transition-all duration-200 ${
                                      isRetro
                                  ...
                                  >
                                    <svg
                                      className="h-6 w-6 fill-current text-white ml-0.5"
                                      viewBox="0 0 24 24"
                                    >
                          ...
                          {details.posterUrl && (
                            <div
                              className={`absolute -bottom-8 left-6 z-20 w-[95px] sm:w-[110px] aspect-[2/3] overflow-hidden border-2 transform hover:scale-105 transition-transform ${
                                isRetro
                                  ? "border-tui-border rounded-none"
                                  : "rounded-xl border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.85)]"
                              }`}
                            >
                              <TMDBImage
                        ...
                        <div className="space-y-3 pt-4">
                          {/* Directors */}
                          <div
                            className={`flex items-center py-3.5 border-b ${isRetro ? "border-tui-border" : "border-white/[0.08]"}`}
                          >
                            <span
                              className={`font-semibold w-24 shrink-0 ${isRetro ? "text-tui-text-muted" : "text-zinc-500"}`}
                            >
                              Director
                            </span>
                      ...
                      <div className="lg:col-span-6 text-left space-y-6">
                        <div className="space-y-4">
                          <h2
                            className={`text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight ${isRetro ? "text-tui-text uppercase" : "text-white"}`}
                          >
                            {details.title}
                          </h2>
                        ...
                        <p
                          className={`text-sm leading-relaxed max-w-xl font-normal ${isRetro ? "text-tui-text-muted" : "text-zinc-400"}`}
                        >
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                          {details.voteAverage != null && (
                            ...
                            >
                              <Star
                                className={`h-5 w-5 fill-current ${isRetro ? "text-tui-amber" : "text-amber-400"}`}
                              />
                              <span
                                className={`text-xl font-bold ${isRetro ? "text-tui-text" : "text-white"}`}
                              >
                                {details.voteAverage.toFixed(1)}
                              </span>
                              <span
                                className={`text-xs ${isRetro ? "text-tui-text-muted" : "text-zinc-500"}`}
                              >
                                /10
                              </span>
                              {details.voteCount != null && (
                                <span
                                  className={`text-[10px] ml-1 ${isRetro ? "text-tui-text-muted" : "text-zinc-500"}`}
                                >
                          ...
                          <div className="relative">
                            <button
                              onClick={() =>
                                onSetShowRatingSelector(!showRatingSelector)
                              }
                            ...
                            >
                              <Star
                                className={`h-4 w-4 ${userRating != null ? "fill-amber-400 text-amber-400" : ""}`}
                              />
                              {userRating != null ? `${userRating}/10` : "Rate"}
                            </button>
                            {showRatingSelector && (
                              <div
                                className={`absolute top-full left-0 mt-2 z-50 p-3 ${
                                  isRetro
                                ...
                                {userRating != null && (
                                  <button
                                    ...
                                    className={`w-full text-center text-[10px] py-1 cursor-pointer ${
                                      isRetro
                                        ? "text-tui-text-muted hover:text-red-500"
                        ...
                        <div className="flex flex-wrap gap-3 pt-2">
                          {watchlistItem ? (
                            <>
                              ...
                              >
                                <Heart
                                  className={`h-4 w-4 ${watchlistItem.favorite ? "fill-rose-400 text-rose-400" : ""}`}
                                />
                            ...
                            <>
                              <button
                                onClick={() =>
                                  onAddToWatchlist(details, "watched")
                                }
                              ...
                              <button
                                onClick={() =>
                                  onAddToWatchlist(details, "pending")
                                }
                                className={`flex items-center gap-2 px-5 py-2.5 border text-sm font-semibold transition-all cursor-pointer ${
                                  isRetro
                                    ? "border-tui-border bg-tui-bg text-tui-text-muted hover:border-tui-text font-mono"
                        ...
                        <div className="pt-4">
                          <h3
                            className={`text-sm font-bold uppercase tracking-wider mb-4 ${isRetro ? "text-tui-text" : "text-zinc-300"}`}
                          >
                            Cast
                          </h3>
                              ...
                              >
                                ...
                                >
                                  {c.profileUrl ? (
                                    ...
                                    <div
                                      className={`h-full w-full flex items-center justify-center text-xs font-bold uppercase ${
                                        isRetro
                                          ? "text-tui-text-muted bg-tui-bg"
                                          : "text-zinc-500"
                                      }`}
                                    >
                                ...
                                <div className="text-left leading-normal min-w-0 flex flex-col justify-center">
                                  ...
                                  <span
                                    className={`text-[11px] truncate mt-0.5 block ${
                                      isRetro
                                        ? "text-tui-text-muted"
                                        : "text-zinc-400"
                                    }`}
                ...
                <div className="max-w-2xl mx-auto space-y-4 font-mono text-xs text-center py-20">
                  <div>
                    FAILED TO SYNCHRONIZE DEEP DATA. RETRY OR USE BASIC VIEW.
                  </div>
                  <button
                    onClick={onClose}
