...
const POSTERS = [
  ...
  },
  {
    ...
    genre: "Thriller",
    type: "movie",
    poster: "https://image.tmdb.org/t/p/w342/ljsZTbVsrQSqZgWeep2B1QiDKuh.jpg",
    status: "watched" as const,
    fav: true,
    rating: 5,
  },
  ...
  },
  {
    ...
    genre: "Action",
    type: "movie",
    poster: "https://image.tmdb.org/t/p/w342/8tZYtuWezp8JbcsvHYO0O46tFbo.jpg",
    status: "watched" as const,
    fav: true,
    rating: 5,
  },
  ...
  return (
    <svg width="100" height="100" viewBox="0 0 100 100">
      ...
      <text
        ...
        y="47"
        textAnchor="middle"
        className="fill-white/80 font-bold"
        style={{ fontSize: "18px" }}
      >
        8
      </text>
        ...
        <div>
          ...
          <div className="mt-2 flex flex-wrap gap-1.5">
            {GENRES.map((g) => (
              <span
                key={g}
                className="px-2 py-1 rounded text-[9px] text-white/35 bg-white/[0.03] border border-white/[0.05]"
              >
                {g}
              </span>
            ))}
      ...
      <div className="flex-1 min-w-0 space-y-4 pr-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-white/30 mt-0.5">
            {POSTERS.length} titles in your collection
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
          {POSTERS.slice(0, 10).map((item, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`relative overflow-hidden rounded-md bg-white/[0.03] ring-1 transition-all duration-300 ${
                    isHighlighted
                      ? "ring-white/30 scale-[1.04]"
                      : "ring-white/[0.06]"
                  }`}
                >
                  ...
                  <AnimatePresence>
                    {isHighlighted && (
                      ...
                      >
                        <span
                          className={`inline-flex items-center gap-0.5 rounded-full px-1 py-0.5 text-[7px] font-medium ${st.bg} ${st.color} w-fit`}
                        >
    ...
    <div className="space-y-3">
      ...
      <div className="relative overflow-hidden rounded-lg bg-white/[0.025] border border-white/[0.06] p-4">
        <div className="absolute inset-0 overflow-hidden rounded-lg pointer-events-none">
          <div
            className="absolute w-[250px] h-[180px] rounded-full blur-[50px] opacity-40 -top-8 -left-8"
            style={{
              background:
          ...
          />
          <div
            className="absolute w-[200px] h-[150px] rounded-full blur-[50px] opacity-30 -bottom-8 -right-8"
            style={{
              background:
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              >
                <div className="text-xl sm:text-2xl font-bold tracking-tight bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent truncate">
                  {ins.value}
                </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        {kpis.map((kpi, i) => (
          ...
          >
            <div
              className="inline-flex items-center justify-center h-6 w-6 rounded-md mb-1.5"
              style={{ background: kpi.color }}
            >
              <kpi.icon className="h-3 w-3 text-white/70" />
            </div>
            <div className="text-lg font-bold tracking-tight text-white/90 tabular-nums">
              {kpi.value}
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              {[
                ...
                <div key={s.l} className="flex items-center gap-1.5">
                  ...
                  <span className="text-[9px] font-semibold text-white/70 ml-auto tabular-nums">
                    {s.v}
                  </span>
                </div>
              ))}
          ...
          <div className="flex flex-col gap-1.5">
            {quickStats.map((stat, i) => (
              ...
              >
                ...
                <span className="ml-auto text-[9px] font-semibold text-white/70 tabular-nums">
                  {stat.value}
                </span>
              </motion.div>
            ))}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="absolute inset-0 scale-110">
              <TMDBImage
                src={featuredItems[activeIndex].poster}
                alt=""
                fill
              ...
              <div className="flex-1 min-w-0 pr-4">
                ...
                >
                  ...
                  <span className="flex items-center gap-0.5 text-amber-400">
                    ...
                    {featuredItems[activeIndex].rating}.0
                  </span>
                </motion.div>
      ...
      <div className="flex gap-2 px-1 overflow-x-auto scrollbar-hide flex-shrink-0 pb-1">
        {categories.map((cat, i) => (
          ...
          >
            ...
            <span
              className={`text-[10px] font-bold ${cat.color} tracking-wide`}
            >
              {cat.name}
            </span>
          </motion.div>
        ...
        <div className="flex gap-3 overflow-x-hidden px-1">
          {forYou.map((item, i) => (
            ...
            >
              <div className="rounded-lg overflow-hidden border border-white/10 relative aspect-[2/3] mb-2 shadow-lg">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-2 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out">
                  <div className="flex justify-between items-center">
                    <span className="text-[8px] font-bold text-white bg-white/20 backdrop-blur-md px-1.5 py-0.5 rounded uppercase">
                      {item.type}
                    </span>
              ...
              <h4 className="text-[11px] font-semibold text-white/80 truncate group-hover:text-white transition-colors">
                {item.title}
              </h4>
      ...
      <div className="relative z-10 p-4 sm:p-5 flex flex-col h-full">
        ...
        <div className="flex items-center gap-0.5 p-0.5 rounded-lg bg-white/[0.03] border border-white/[0.05] mb-3 flex-shrink-0">
          {TABS.map((tab) => (
            <button
              ...
              className={`relative flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-md text-[10px] font-medium transition-all duration-300 ${
                activeTab === tab.id
                  ? "text-white"
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden scrollbar-hide">
          <AnimatePresence mode="wait">
            ...
            >
              {activeTab === "library" && (
                <LibraryTab highlightPoster={highlightPoster} />
              )}
