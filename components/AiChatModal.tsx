                ...
                {messages.length === 0 && (
                  ...
                  >
                    <div className="space-y-2 mb-8 mt-auto">
                      ...
                      <p className="text-xs text-white/40 max-w-[250px] leading-relaxed mx-auto">
                        I can recommend movies, semantic search by vibe, or
                        automatically add items to your library.
                      </p>
                    </div>
